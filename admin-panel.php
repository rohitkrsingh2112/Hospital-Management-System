...
function generate_bill() {
  ...
  $query = mysqli_query($con, "SELECT p.pid, p.ID, p.fname, p.lname, p.doctor, p.appdate, p.apptime, p.disease, p.allergy, p.prescription, a.docFees 
                              FROM prestb p INNER JOIN appointmenttb a ON p.ID=a.ID AND p.pid='$pid' AND p.ID='".$_GET['ID']."'");
...
if(isset($_GET["generate_bill"])) {
  ...
  $content .= '
      <br/>
      <h2 align="center"> Rohit Medicare</h2></br>
...
<head>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
    <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Rohit Medicare </a>
